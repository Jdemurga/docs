...
The codebase is organized into domain-aligned modules.

| Module | Responsibility |
|---|---|
| `Auth` | User registration, login, Sovereign Link session binding, preferences |
| `Market` | Market data, portfolios, watchlists, trading, reports, RWA, insurance, taxes, yield |
| `Governance` | DAO proposals and voting |
| `Events` | Socket.io gateways for real-time signaling and high-frequency terminal data |
| `Sentiment` | Bridge to Vexel Brain for sentiment analysis |
| `Common` | Security, HSM, vault, ledger, trust, and Redis mesh services |
| `Database` | TypeORM connection and shared entities |
